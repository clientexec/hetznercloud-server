...
export default function RFB(target, url, options) {
    ...
    this._screen.style.width = '100%'; //100%
    this._screen.style.height = '100%'; //100%
    this._screen.style.overflow = 'hidden'; //hidden or auto
	this._screen.style.margin = '5px'; //New line
	...
	//New line
	this._canvas.style.width = '100%'; //100%
    this._canvas.style.height = '100%'; //100%
	//New line
    this._canvas.style.flexShrink = '0';
    this._canvas.width = '0'; //0
    this._canvas.height = '0'; //0
